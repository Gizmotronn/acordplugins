...
function yz_buddypress_register_form_terms() {
    ...
    <div class="logy-form-note logy-terms-note">
        <?php echo sprintf( __( 'By creating an account you agree to our <a href="%1s">Terms and Conditions</a> and our <a href="%2s" >Privacy Policy</a>.', 'youzer' ), $terms_url, $privacy_url ); ?>
    </div>
