		...
		case 'register':
			...
			if ( 'on' == logy_options( 'logy_show_terms_privacy_note' ) ) {
				...
				$fields[] = array(
					...
					'note'  => sprintf( __( 'By creating an account you agree to our <a href="%1s">Terms and Conditions</a> and our <a href="%2s" >Privacy Policy</a>.', 'youzer' ), $terms_url, $privacy_url )
				);
			}
