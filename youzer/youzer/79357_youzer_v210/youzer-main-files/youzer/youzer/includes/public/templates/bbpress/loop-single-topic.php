...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
				...
				<?php if ( bbp_is_user_home() ) : ?>
					...
					<?php if ( bbp_is_favorites() ) : ?>
						...
						<span class="bbp-row-actions">
							...
							<?php bbp_topic_favorite_link( array( 'before' => '', 'favorite' => '<span  data-yztooltip="' . __( 'Like', 'youzer' ) . '"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>', 'favorited' => '<span  data-yztooltip="' . __( 'Unlike', 'youzer' ) . '"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></span>' ) ); ?>
					...
					<?php elseif ( bbp_is_subscriptions() ) : ?>
						...
						<span class="bbp-row-actions">
							...
							<?php bbp_topic_subscription_link( array( 'before' => '', 'subscribe' => '<span  data-yztooltip="' . __( 'Subscribe', 'youzer' ) . '"><i class="fa fa-bell" aria-hidden="true"></i></span>', 'unsubscribe' => '<span  data-yztooltip="' . __( 'Unsubscribe', 'youzer' ) . '"><i class="fa fa-bell-slash-o" aria-hidden="true"></i></span>' ) ); ?>
	...
	<li class="bbp-topic-voice-count"><i class="fa fa-microphone" area-hidden="true"></i><?php bbp_topic_voice_count(); ?></li>

	<li class="bbp-topic-reply-count"><i class="fa fa-comments" area-hidden="true"></i><?php bbp_show_lead_topic() ? bbp_topic_reply_count() : bbp_topic_post_count(); ?></li>
