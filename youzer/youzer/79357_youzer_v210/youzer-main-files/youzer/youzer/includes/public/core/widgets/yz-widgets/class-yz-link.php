        ...
        <div class="yz-link-content link-with-img">
            ...
            <div class="yz-link-main-content">
                <div class="yz-link-inner-content">
                    <div class="yz-link-icon"><i class="fa fa-unlink" aria-hidden="true"></i></div>
                    <?php if ( $link_txt ) : ?>
                        <p><?php echo $link_txt; ?></p>
                    <?php endif; ?>
                    <a href="<?php echo $link_url; ?>" class="yz-link-url" target="_blank"><?php echo yz_esc_url( $link_url ); ?></a>
                </div>
            </div>
        </div>
