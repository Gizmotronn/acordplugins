...
class Youzer_Author {
	...
	function get_box_structure( $layout = null ) {
		...
		$structure['yzb-author-v1'] = array(
			'cover'	  => array( 'photo' ),
			'content' => array( 'box_head', 'badges', 'buttons', 'networks', 'statistics' )
		);

		$structure['yzb-author-v2'] = array(
			'cover'	  => array( 'photo' ),
			'content' => array( 'box_head', 'badges', 'buttons', 'statistics', 'networks' )
		);

		$structure['yzb-author-v3'] = array(
			'cover'	  => array( 'photo', 'box_head' ),
			'content' => array( 'badges', 'statistics' , 'buttons', 'networks' )
		);

		$structure['yzb-author-v4'] = array(
			'cover'	  => array( 'photo', 'box_head' ),
			'content' => array( 'badges', 'buttons', 'networks', 'statistics' )
		);

		$structure['yzb-author-v5'] = array(
			'content' => array( 'photo', 'box_head', 'badges', 'buttons', 'statistics', 'networks' )
		);

		$structure['yzb-author-v6'] = array(
			'cover'	=> array( 'photo', 'box_head', 'badges', 'buttons', 'networks', 'statistics' )
		);
