...
function yz_bbp_forum_topic_head( $args = array() ) {
	...
	<div class="yz-bbp-topic-head-meta">
		...
		<div class="yz-bbp-topic-head-meta-item">
			<i class="fa fa-microphone"></i><?php echo $voice_count; ?>
		</div>
		<div class="yz-bbp-topic-head-meta-item">
			<i class="fa fa-comments"></i><?php echo $reply_count; ?>
		</div>
	</div>
...
function yz_bbp_single_forum_head_meta(  $args = '' ) {
	...
	<div class="yz-bbp-topic-head-meta">
		...
		<div class="yz-bbp-topic-head-meta-item">
			<i class="fa fa-pencil"></i><?php echo $topic_text; ?>
		</div>
		<?php endif; ?>
		<?php if ( isset( $reply_text ) ) : ?>
		<div class="yz-bbp-topic-head-meta-item">
			<i class="fa fa-comments"></i><?php echo $reply_text; ?>
		</div>
		<?php endif; ?>
	</div>
<?php
