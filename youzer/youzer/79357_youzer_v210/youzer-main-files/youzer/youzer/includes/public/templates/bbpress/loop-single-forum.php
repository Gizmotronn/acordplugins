...
<ul id="bbp-forum-<?php bbp_forum_id(); ?>" <?php bbp_forum_class(); ?>>
			...
			<div class="yz-forums-forum-head">
				...
				<?php if ( bbp_is_user_home() && bbp_is_subscriptions() ) : ?>
					...
					<span class="bbp-row-actions">
						...
						<?php bbp_forum_subscription_link( array( 'before' => '', 'subscribe' => '<span  data-yztooltip="' . __( 'Subscribe', 'youzer' ) . '"><i class="fa fa-bell" aria-hidden="true"></i></span>', 'unsubscribe' => '<span  data-yztooltip="' . __( 'Unsubscribe', 'youzer' ) . '"><i class="fa fa-bell-slash-o" aria-hidden="true"></i></span>' ) ); ?>
	...
	<li class="bbp-forum-topic-count"><i class="fa fa-file-text" area-hidden="true"></i><?php bbp_forum_topic_count(); ?></li>

	<li class="bbp-forum-reply-count"><i class="fa fa-pencil" area-hidden="true"></i><?php bbp_show_lead_topic() ? bbp_forum_reply_count() : bbp_forum_post_count(); ?></li>
