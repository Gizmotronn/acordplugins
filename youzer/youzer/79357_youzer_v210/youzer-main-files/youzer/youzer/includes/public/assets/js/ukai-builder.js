( function( $ ) {
     ...
     */
	 ...
	 $.ukai_form_input = function( options ) {
        ...
        // Default options
        var input_label, open_option, field_class, input,
		...
		switch( s.input_type ) {
            ...
            case 'number':
                input = '<input type="number" name="' + input_name + '" ' + field_class + placeholder + '>';
                break;
		    ...
		    case 'image':
                ...
                input += '<input type="hidden" name="' + s.options_name + '[' + s.cell + '][thumbnail]' + '" ' + ' class="yz-photo-thumbnail"' + '>';
                // input += '<input type="hidden" name="' + input_name + '" ' + field_class + '>';
                input += '</div>';
                break;
