...
<?php if ( bp_has_activities( bp_ajax_querystring( 'activity' ) ) ) : ?>
	...
	<?php while ( bp_activities() ) : bp_the_activity(); ?>
		...
		<?php /* Exclude Unwated Activity Types */ ?>
		<?php if ( yz_exclude_activity() ) { continue; } ?> 	
	...
	<?php if ( bp_activity_has_more_items() ) : ?>
		...
		<li class="load-more">
			<a href="<?php bp_activity_load_more_link() ?>"><i class="fa fa-level-down"></i><?php _e( 'Load More Posts', 'youzer' ); ?></a>
		</li>
