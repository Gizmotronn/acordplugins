...
class Youzer_Wall {
	    ...
	    <div class="yzw-quote-post">
		    <div class="yzw-quote-content quote-with-img">
		        ...
		        <div class="yzw-quote-main-content">
		            <div class="yzw-quote-icon"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
	...
	function get_wall_post_file( $attachments ) { 
		...
		<div class="yzw-file-post">
			<i class="fa fa-cloud-download yzw-file-icon" aria-hidden="true"></i>
			...
			<a href="<?php echo $file_url; ?>" class="yzw-file-download"><i class="fa fa-download" aria-hidden="true"></i><?php _e( 'download', 'youzer' ); ?></a>
		</div>
	...
	function get_wall_post_link( $attachments, $activity_id ) {
		...
		<a class="yz-wall-link-content" href="<?php echo $link_url; ?>">
	...
	function get_activity_url_preview( $activity_id, $activity_content = null ) {
		...
		// Unserialize data.
		$url_data = is_serialized( $url_data ) ? unserialize( $url_data ) : base64_decode( unserialize( $url_data ) );
		...
		<a class="yz-wall-link-content" href="<?php echo $url_data['link']; ?>">
