    ...
    foreach ( $visible_menu as $menu_item ) :
        ...
        <li class="yz-navbar-item <?php echo $menu_data['class']; ?>">
            <a href="<?php echo esc_url( $menu_data['link'] ); ?>">
                <?php if ( 'on' == $display_icons && ! empty( $menu_data['icon'] ) ) : ?><i class="fa fa-<?php echo $menu_data['icon']; ?>" aria-hidden="true"></i><?php endif; ?><?php echo $menu_data['title']; ?></a>
        </li>
...
function yz_get_profile_nav_menu_icon( $slug = null ) {
    ...
    // Default Icon.
    $default_icon = isset( $default_tabs[ $slug ] ) ? $default_tabs[ $slug ]['icon'] : 'globe';
...
function yz_get_secondary_tabs_icons( $menu_item, $subnav_item, $selected_item ) {
	...
	return '<li id="' . esc_attr( $subnav_item->parent_slug . '-' . $subnav_item->css_id . '-' . $list_type . '-li' ) . '" ' . $selected . '><a id="' . esc_attr( $subnav_item->css_id ) . '" href="' . esc_url( $subnav_item->link ) . '"><i class="fa fa-' . $tab_icon . '" aria-hidden="true"></i>' . $subnav_item->name . '</a></li>';
...
function yz_add_profile_third_party_subtabs_icons() {
	...
	// Get Buddypress Custom Tabs.
	$bp_custom_tabs = yz_get_profile_third_party_subtabs();
	
	if ( empty( $bp_custom_tabs ) ) {
		return false;
	}
...
function yz_user_account_avatar() {
    ...
    <div class="yz-primary-nav-area">
        ...
        <div class="yz-primary-nav-settings">
            ...
            <?php if ( 'on' == $display_icon ) : ?><i class="fa fa-angle-down yz-settings-icon" aria-hidden="true"></i><?php endif; ?>
        </div>
