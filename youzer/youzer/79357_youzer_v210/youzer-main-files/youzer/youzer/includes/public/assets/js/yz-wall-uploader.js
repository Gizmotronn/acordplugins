		...
		$.youzerAttachmentItem = function ( options ) {
			...
			file_code =  '<div class="yz-attachment-item yz-file-preview">' +
							'<div class="yz-attachment-details">' +
								'<i class="fa fa-hourglass-half yz-file-icon"></i>' +
		...
		$.yz_UploadFile = function ( file ) {
		    ...
		    $.ajax({
	                    ...
	                    YouzerXhr.upload.addEventListener( 'progress', function( e ) {
						    if ( e.lengthComputable ) {
						        ...
						        // Get Progress Bar
						       	...
						       	var yz_loading_icon = 'fa fa-spinner fa-spin yz-file-icon';
		        ...
		        success: function( result ) {
			        ...
			        // Prepare Trash Icon
		        	var trash_icon = '<i class="fa fa-trash yz-delete-attachment"></i>',
		        		paperclip_icon = 'fa fa-paperclip yz-file-icon';
