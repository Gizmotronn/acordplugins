	...
	function get_notifications( $args ) {
		...
		<div class="yz-notif-item yz-notif-<?php echo $notification->component_action; ?>">
			...
			<div class="yz-notif-content">
				...
				<span class="yz-notif-time"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo bp_core_time_since( $notification->date_notified ); ?></span>
			</div>
		</div>
        ...
        <?php if ( $notifications_nbr > $args['limit'] ) : ?>
            <div class="yz-more-items">
                <a href="<?php echo bp_nav_menu_get_item_url( 'notifications' ); ?>"><i class="fa fa-bell-o" aria-hidden="true"></i><?php echo sprintf( __( 'Show All Notifications ( %s )', 'youzer' ), $notifications_nbr ); ?></a>
            </div>
        <?php endif; ?>
	...
	function get_notification_icon( $args ) {
		...
		switch ( $notification_action ) {
			...
			case 'membership_request_rejected':
				$icon = '<i class="fa fa-thumbs-o-down" aria-hidden="true"></i>';
				break;
			...
			$icon = '<i class="fa fa-reply" aria-hidden="true"></i>';
				break;				
			case 'update_reply':
				$icon = '<i class="fa fa-mail-reply-all" aria-hidden="true"></i>';
				break;
