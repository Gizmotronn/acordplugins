            ...
            <figure class="yz-project-item">
                ...
                <figcaption class="yz-pf-buttons">
                        ...
                        <?php if ( 'on' == $display_zoom ) : ?>
                            <a class="yz-pf-zoom"><i class="fa fa-search"></i></a>
                        <?php endif; ?>

                        <a class="yz-lightbox-img" href="<?php echo $full_photo_path; ?>" data-lightbox="yz-instagram" <?php echo $data_data; ?>></a>
                </figcaption>
            </figure>
        </li>
