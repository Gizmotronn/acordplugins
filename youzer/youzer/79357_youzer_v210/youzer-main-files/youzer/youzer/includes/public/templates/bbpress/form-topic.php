			...
			<div class="bbp-form yz-bbp-box">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><i class="fa fa-send" aria-hidden="true"></i><?php _e( 'Submit', 'bbpress' ); ?></button>
