	...
	function get_option( $options_name, $is_user, $option, $real_value ) {
		...
		case 'openBox':
			...
			<div class="<?php echo yz_generate_class( $box_class ); ?>">
				...
				<i class="fa fa-angle-up kl-hide-box-icon" aria-hidden="true"></i>
				<?php endif; ?>
		...
		case 'image':
			...
			$trash_icon_class = 'fa fa-trash yz-delete-photo';
		...
		case 'connect':
			...
			<div class="<?php echo $connect_class; ?>" >
				...
				<div class="yz-user-provider-box">
					...
					<div class="yz-user-provider-unlink" data-yztooltip="<?php _e( 'Unlink Account', 'youzer' ); ?>" data-provider="<?php echo $option['provider']; ?>" data-nonce="<?php echo $ajax_nonce; ?>"><i class="fa fa-trash" aria-hidden="true"></i></div>
				</div>
				<?php endif; ?>
				
				<div class="yz-connect-btn yz-connect-btn-<?php echo $option['provider'];?>">
					<a href="<?php echo home_url( '/?action=yz_account_connect&provider=' . $option['provider'] );?>"><i class="fa fa-<?php echo $option['icon']; ?>"></i><?php echo $option['button']; ?></a>
				</div>
