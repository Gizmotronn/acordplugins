...
function yz_get_md_current_user_settings( $user_id = false ) {
    ...
    <a href="<?php echo yz_get_profile_settings_url( false, $user_id ); ?>" class="yz-profile-settings"><i class="fa fa-user-circle" aria-hidden="true"></i><?php _e( 'profile settings', 'youzer' ); ?></a>

    <?php if ( bp_is_active( 'friends' ) && bp_is_active( 'messages' ) && 'block' == $buttons_layout ) : ?>

        <?php if ( bp_is_active( 'settings' ) ) : ?>
            <a href="<?php echo yz_get_settings_url( false, $user_id ); ?>" class="yzmd-second-btn"><i class="fa fa-cogs" aria-hidden="true"></i><?php _e( 'account settings', 'youzer' ); ?></a>
        <?php else : ?>
            <a href="<?php echo yz_get_widgets_settings_url( false, $user_id ); ?>" class="yzmd-second-btn"><i class="fa fa-sliders" aria-hidden="true"></i><?php _e( 'widgets settings', 'youzer' ); ?></a>
        <?php endif; ?>
...
function yz_get_md_user_meta( $user_id = null ) {
    ...
    if ( empty( $meta_value ) ) {
        // Set Default Meta.
        $meta_html = '<i class="fa fa-at" aria-hidden="true"></i>' . bp_core_get_username( $user_id );
    } else {
