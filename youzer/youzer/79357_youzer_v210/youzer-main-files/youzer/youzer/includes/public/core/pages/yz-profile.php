...
class Youzer_Profile {
	...
	function profile_scripts() {
        ...
        if ( ( $slideshow && $is_slideshow_visible ) || bp_is_current_component( 'activity' ) ) {
        ...
        if ( $portfolio || $flickr || $instagram || bp_is_current_component( 'activity' ) || bp_is_current_component( 'groups' ) ) {
