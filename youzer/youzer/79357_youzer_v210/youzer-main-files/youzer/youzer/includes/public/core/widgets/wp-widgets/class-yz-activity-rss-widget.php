...
class YZ_Activity_Rss_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'yz_activity_rss',
			__( 'Youzer - Members Activity RSS', 'youzer' ),
			array(
				'description' => __( 'Members Activity Rss Widget ( Works only on global activity page )', 'youzer' )
			)
		);
	...
	public function form( $instance ) {
	    ...
	    $defaults = array(
	        'left_color'  => '#FF5722',
	        'right_color' => '#F9D423',
	        'title' 	  => __( 'Members Activity RSS', 'youzer' ),
	    );
	...
	public function widget( $args, $instance ) {
		...
		<div class="yz-wp-widget-box yz-wp-activity-rss-box <?php echo $args['widget_id']; ?>">
