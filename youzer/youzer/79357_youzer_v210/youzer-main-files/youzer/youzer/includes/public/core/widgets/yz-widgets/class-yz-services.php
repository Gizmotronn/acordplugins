...
class YZ_Services {
    ...
    function widget() {
        ...
        <?php
            ...
            if ( ! empty( $services ) ) :
                ...
                $service_icon  = ! empty( $service['icon'] ) ? $service['icon'] : 'globe';
                ...
                <div class="yz-service-inner">
                    ...
                    <?php if ( 'on' == $display_icon && $service_icon ) : ?>
                        <div class="yz-service-icon yz-icons-<?php echo $icon_border; ?>">
                            <i class="fa fa-<?php echo $service_icon ;?>" aria-hidden="true"></i>
                        </div>
                    <?php endif; ?>
    ...
    function get_user_services() {
        ...
        foreach ( $services_options as $service ) : $i++;
            ...
            // init Variables.
            $service_title = sanitize_text_field( $service['wg_service_title'] );
            $service_desc  = esc_textarea( $service['wg_service_desc'] );
            $service_icon  = ! empty( $service['wg_service_icon'] ) ? $service['wg_service_icon'] : 'globe';
            ...
            <div class="yz-wg-container">
                        ...
                        <div class="option-content">
                            <div id="ukai_icon_<?php echo $i; ?>" class="ukai_iconPicker" data-icons-type="web-application">
                                <div class="ukai_icon_selector">
                                    <i class="fa fa-<?php echo $service_icon; ?>" aria-hidden="true"></i>
                                    <span class="ukai_select_icon"><i class="fa fa-sort-desc" aria-hidden="true"></i></span>
                                </div>
                                <input type="hidden" class="ukai-selected-icon" name="youzer_services[<?php echo $i; ?>][wg_service_icon]" value="<?php echo $service_icon; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-option-item">
                    <div class="yz-option-inner">
                        ...
                        <div class="option-content">
                            <input type="text" name="youzer_services[<?php echo $i; ?>][wg_service_title]" value="<?php echo $service_title; ?>" placeholder="<?php echo $label_title; ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-option-item">
                    <div class="yz-option-inner">
                        ...
                        <div class="option-content">
                            <textarea name="youzer_services[<?php echo $i; ?>][wg_service_desc]" placeholder="<?php echo $label_desc; ?>"><?php echo $service_desc; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
