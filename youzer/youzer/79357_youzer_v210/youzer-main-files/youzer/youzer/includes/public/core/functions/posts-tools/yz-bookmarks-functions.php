...
/**
 * Get FoBookmars llows Tab Content.
 */
...
function yz_bookmarks_scripts() {
    ...
    if ( yz_is_user_can_bookmark() && yz_is_activity_component() ) {

    	global $Youzer;

        // Call Bookmark Posts Script.
        wp_enqueue_script( 'yz-bookmark-posts', YZ_PA . 'js/yz-bookmark-posts.min.js', array( 'jquery' ), $Youzer->version, true );
...
add_action( 'wp_enqueue_scripts', 'yz_bookmarks_scripts' );
