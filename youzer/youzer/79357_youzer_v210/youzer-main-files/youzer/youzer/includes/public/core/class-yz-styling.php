...
class Youzer_Styling {
    ...
    function get_all_styles() {
        ...
        // Get Styles
        $styles = array_merge( $this->posts_tab_styling( array(), true ), $this->comments_tab_styling( array(), true ), $this->group_styling( array(), true ), $this->profile_styling( array(), true ),  $this->profile404_styling( array(), true ) );
     ...
     * Styling Data.
     */
    public function profile_styling( $elements = null, $get_array = false ) {
