...
class Youzer_Panel {
	...
	<div id="ukai-panel" class="<?php echo yz_options( 'yz_panel_scheme' ); ?>">
	    ...
	    <div class="uk-sidebar">
	        ...
	        <a class="yz-tab-extensions" href="<?php echo apply_filters( 'youzer_panel_extensions_page_link', menu_page_url( 'yz-extensions', false ) ); ?>"><i class="fa fa-plug" aria-hidden="true"></i><?php _e( 'Extensions <span class="new">New</span>') ?></a>
	...
	<?php if ( 'on' == yz_options( 'yz_enable_panel_fixed_save_btn' ) ) : ?>
		<div class="yz-fixed-save-btn"><i class="fa fa-floppy-o" aria-hidden="true"></i></div>
	<?php endif; ?>
	...
	function modal( $args, $modal_function ) {
		...
		<div class="yz-md-modal yz-md-effect-1" id="<?php echo $args['id'] ;?>">
			<h3 class="yz-md-title" data-title="<?php echo $title; ?>">
				<?php echo $title; ?>
                <i class="fa fa-close yz-md-close-icon" aria-hidden="true"></i>
			</h3>
