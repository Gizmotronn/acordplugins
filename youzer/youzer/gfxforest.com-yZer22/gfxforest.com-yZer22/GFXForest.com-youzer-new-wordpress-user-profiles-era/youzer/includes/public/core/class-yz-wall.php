...
class Youzer_Wall {
     ...
     */
	function wall_post_attachments( $activity_id = null ) {

		global $activities_template;

		// Get Activity ID.
		$activity_id = ! empty( $activity_id ) ? $activity_id : $activities_template->activity->id;
	...
	function get_activity_url_preview( $activity_id, $activity_content = null ) {
		...
		<a class="yz-wall-link-content" rel="nofollow" href="<?php echo $url_data['link']; ?>" target="_blank">
...
// die( json_encode( array('error' => 'ok' ) ) );
