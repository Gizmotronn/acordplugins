	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<div class="bbp-form yz-bbp-box">
				<div class="yz-bbp-box-title"><i class="far fa-comments"></i><?php printf( __( 'Reply To: %s', 'bbpress' ), bbp_get_topic_title() ); ?></div>
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit"><i class="far fa-paper-plane"></i><?php _e( 'Submit', 'bbpress' ); ?></button>
