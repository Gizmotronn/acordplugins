...
class Hybrid_Endpoint {
	...
	protected function processAuthStart() {
		...
		if (!Hybrid_Auth::storage()->get("hauth_session.$provider_id.hauth_endpoint")) {
			...
			throw new YZHybrid_Exception("You cannot access this page directly.");
		}
		...
		if (!$hauth) {
			...
			throw new YZHybrid_Exception("Invalid parameter! Please return to the login page and try again.");
		}
	...
	protected function authInit() {
		if (!$this->initDone) {
			...
			try {
				...
				if (!class_exists("YZHybrid_Exception", false)) {
				...
				throw new YZHybrid_Exception( "Endpoint: Error while trying to init Hybrid_Auth: " . $e->getMessage(), $e->getCode(), $e );
			}
		}
	}
