...
class Youzer_Account {
	...
	function rename_tabs() {
		...
		if ( bp_is_active( 'settings' ) ) {
		    ...
		    bp_core_new_nav_default (
		        array(
		            'subnav_slug'       => apply_filters( 'yz_acccount_settings_default_tab', 'notifications' ),
	    ...
	    // bp_core_new_nav_default (
	    //     array(
	    //         'subnav_slug'       => apply_filters( 'yz_profile_settings_default_tab', 'edit' ),
	...
	function settings_scripts() {
	    ...
	    // Widgets Builder
	    wp_register_script( 'yz-builder', YZ_PA . 'js/ukai-builder.min.js', array( 'jquery-ui-sortable', 'jquery-ui-draggable' ), $Youzer->version, true );
	    ...
	    // Admin Panel Script
	    wp_enqueue_script( 'yz-panel', YZ_PA . 'js/yz-settings-page.min.js', array( 'jquery' ), $Youzer->version, true );
