( function( $ ) {
	...
	$( document ).ready( function() {
		...
		$.yz_set_content_height = function() {
			// Portfolio Photos Resize
			var pf_img_height = $( '.yz-portfolio .yz-projet-img' ).width();
			$( '.yz-portfolio .yz-projet-img' ).height( pf_img_height );
			// Flickr Photos Resize
			var flickr_img_height = $( '.yz-flickr-photos .yz-projet-img' ).width();
			$( '.yz-flickr-photos .yz-projet-img' ).height( flickr_img_height );
			// Instagram Photos Resize
			var instagram_img_height = $( '.yz-instagram .yz-projet-img' ).width();
			$( '.yz-instagram .yz-projet-img' ).height( instagram_img_height );
