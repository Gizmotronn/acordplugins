...
class Youzer_Admin {
	...
	function admin_scripts() {
	    ...
	    if ( in_array( $_GET['page'], $this->admin_pages ) ) {
	    	...
	    	// Admin Panel Script
	    	wp_enqueue_script( 'yz-panel', YZ_PA . 'js/yz-settings-page.min.js', $jquery, $Youzer->version, true );
	        wp_enqueue_script( 'ukai-panel', YZ_AA . 'js/ukai-panel.min.js', $jquery, $Youzer->version, true );
	...
	function admin_styles() {
	    ...
	    if ( in_array( $_GET['page'], $this->admin_pages ) ) {
	    	...
	    	wp_enqueue_style( 'yz-icons', YZ_AA . 'css/all.min.css', $Youzer->version );
