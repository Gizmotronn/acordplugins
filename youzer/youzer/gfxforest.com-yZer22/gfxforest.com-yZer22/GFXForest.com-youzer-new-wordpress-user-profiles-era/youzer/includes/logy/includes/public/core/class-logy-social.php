...
class Logy_Social {
	...
	public function bp_register_user( $user, $user_meta = null ) {
		...
		$user_password = wp_generate_password();
	 	...
	 	// Add New User.
		$user_id = bp_core_signup_user( $user->displayName, $user_password, $user->email, array( 'social_login' => true ) );
	...
	public function get_config( $provider ) {
		...
		$config = array(
	        'base_url'   => home_url( '/' ),
	        "debug_mode" => apply_filters( 'youzer_social_login_debug_mode', false ),
