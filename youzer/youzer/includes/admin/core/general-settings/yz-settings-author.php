...
function yz_author_box_settings() {
    ...
    $Yz_Settings->get_field(
        array(
            'title' => __( 'statistics visibility settings', 'youzer' ),
            'class' => 'ukai-box-3cols',
            'type'  => 'openBox'
        )
    );
    ...
    $Yz_Settings->get_field(
        array(
            'title' => __( 'comments', 'youzer' ),
            'id'    => 'yz_display_author_comments',
            'desc'  => __( 'display comments number', 'youzer' ),
            'type'  => 'checkbox'
        )
    );
    ...
    $Yz_Settings->get_field(
        array(
            'title' => __( 'views', 'youzer' ),
            'id'    => 'yz_display_author_views',
            'desc'  => __( 'display views number', 'youzer' ),
            'type'  => 'checkbox'
        )
    );
