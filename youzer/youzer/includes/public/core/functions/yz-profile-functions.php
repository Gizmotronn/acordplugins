...
function yz_post_img() {
    ...
    <?php
        ...
        echo '<div class="thumbnail-icon"><i class="fa fa-'. yz_get_format_icon( $post_format ) .'"></i></div>';
        echo '</div>';
    }
}
    ...
    if ( 'post' == $widget ) {
        ...
        if ( $post_id ) {
            ...
            if ( ! empty( $img_url[0] ) ) {
                ...
                echo '<div class="thumbnail-icon"><i class="fa fa-'. yz_get_format_icon( $format ) .'"></i></div>';
                echo '</div>';
            }
        }
    } else {
        ...
        if ( $img_url ) {
            ...
            echo '<div class="yz-no-thumbnail">';
            echo '<div class="thumbnail-icon"><i class="fa fa-camera"></i></div>';
            echo '</div>';
        }
    }
