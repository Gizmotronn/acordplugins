...
function yz_bbpress_default_options( $options ) {
    ...
    $yzsq_options = array(
		...
		'yz_forums_tab_icon' => 'comments',
		'yz_ctabs_forums_subscriptions_icon' => 'bell',
		'yz_ctabs_forums_topics_icon' => 'file-text-o',
		'yz_ctabs_forums_replies_icon' => 'comments-o',
		'yz_ctabs_forums_favorites_icon' => 'thumbs-up',
    );
