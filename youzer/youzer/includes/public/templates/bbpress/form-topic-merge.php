				...
				<div class="bbp-form yz-bbp-box">
					...
					<div>
						...
						<fieldset class="bbp-form">
							...
							<div class="yz-bbp-fieldset-content">
								...
								<div class="yz-bbp-form-item yz-bbp-form-item-checkbox">
									...
									<label for="bbp_topic_favoriters"><?php _e( 'Merge topic favoriters', 'bbpress' ); ?></label>
								</div>
								<?php if ( bbp_allow_topic_tags() ) : ?>

								<div class="yz-bbp-form-item yz-bbp-form-item-checkbox">
									<input name="bbp_topic_tags" id="bbp_topic_tags" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" />
									<label for="bbp_topic_tags"><?php _e( 'Merge topic tags', 'bbpress' ); ?></label>
								</div>
						...
						<div class="bbp-submit-wrapper">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit" name="bbp_merge_topic_submit" class="button submit"><i class="fa fa-send" aria-hidden="true"></i><?php _e( 'Submit', 'bbpress' ); ?></button>
						</div>
					</div>
