...
<div class="item-list-tabs no-ajax" id="subnav" aria-label="<?php esc_attr_e( 'Member secondary navigation', 'youzer' ); ?>" role="navigation">
	<ul>
		...
		<li><a class="yzmsg-show-search"><i class="fa fa-search" aria-hidden="true"></i><?php _e( 'search', 'youzer' ); ?></a></li>
		<?php endif; ?>
	</ul>
	...
	case 'sentbox' :
		...
		<?php if ( bp_is_messages_inbox() ) : ?>
			<h2 class="bp-screen-reader-text"><?php
				...
				_e( 'Messages inbox', 'youzer' );
			?></h2>
		<?php elseif ( bp_is_messages_sentbox() ) : ?>
			<h2 class="bp-screen-reader-text"><?php
				/* translators: accessibility text */
				_e( 'Sent Messages', 'youzer' );
			?></h2>
		<?php endif; ?>
