...
<div id="message-thread">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<div id="message-recipients">
			...
			<div class="highlight-icon"><i class="fa fa-comments-o"></i></div>
			...
			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>"><i class="fa fa-trash" aria-hidden="true"></i><?php _e( 'Delete', 'youzer' ); ?></a>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			...
			<div class="submit">
				<button type="submit" name="send" id="send_reply_button"><i class="fa fa-send" aria-hidden="true"></i><?php esc_attr_e( 'Send', 'youzer' ); ?></button>
			</div>
