	...
	<?php while ( bp_members() ) : bp_the_member(); ?>
		...
		<li <?php bp_member_class(); ?>>
			...
			<div class="yzm-user-data">
				...
				<?php if ( bp_is_members_directory() ) yz_get_user_tools( bp_get_member_user_id() ); ?>
				...
				<?php if ( bp_is_members_directory() ) : ?>
					...
					<a href="<?php bp_member_permalink(); ?>" class="yz-item-avatar">
						<?php $member_avatar = bp_core_fetch_avatar( array( 'item_id' => bp_get_member_user_id(), 'width' => '100', 'height' =>'100', 'type' => 'full', 'html' => false ) ); ?>
						<div class="yz-member-avatar" style="background-image: url(<?php echo esc_url( $member_avatar ); ?>)"></div>
					</a>
