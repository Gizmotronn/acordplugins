...
class YZ_Basic_Infos {
    ...
    function __construct() {
        ...
        // Add new shortcode !.
        add_shortcode( 'yz_basic_information', array( $this, 'get_user_infos_shortcode' ) );
     ...
     * Shortcode.
     */
    function get_user_infos_shortcode( $atts ) {
    ...
    function widget( $user_id = null ) {
        ...
        <div class="yz-infos-content">
            ...
            foreach ( $basic_infos as $info ) {
                $item_value = yz_data( $info['id'], $user_id );
                $value = apply_filters( 'yz_basic_information_widget_item_value', $item_value, $info );
                if ( $value ) {
                    echo "<div class='yz-info-item'>";
                    echo '<div class="yz-info-label">' . $info['name'] . '</div>';
